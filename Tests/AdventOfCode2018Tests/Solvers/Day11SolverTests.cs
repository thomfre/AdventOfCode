...
namespace Thomfre.AdventOfCode2018.Tests.Solvers
{
    ...
    internal class Day11SolverTests : SolverTestBase<Day11Solver>
    {
        ...
        protected override object CorrectAnswer2 => (new Point(90, 269), 16);
        ...
        {
            Point fuelCell = new Point(fuelCellX, fuelCellY);
            int power = Solver.CalculateFuelCellPower(serialNumber, fuelCell);
